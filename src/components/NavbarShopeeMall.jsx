  ...
  return (
    <>
      <div className="text-white absolute top-[0px] flex items-center ml-[256px] mt-[60px]">
        ...
        <div className="flex items-center absolute left-[700px]">
          <div className="w-[520px] h-[40px]">
            <input
              type="text"
              placeholder="Tìm trong Shopee Mall"
              className=" bg-[#FFFFFF] w-[484px] h-[34px] pl-2 font-semibold"
            />
            <span className="w-[50px] h-[30px] bg-[#D0011B] text-white absolute left-[430px] flex items-center justify-center top-[02px]">
